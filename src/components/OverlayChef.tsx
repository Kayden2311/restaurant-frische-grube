...
export const OverlayChef: React.FC<OverlayChefProps> = ({ lang = 'de' }) => {
  return (
    <section
      id="chef"
      className="relative z-10 w-full min-h-[80vh] bg-[#0a0a0b]/95 backdrop-blur-[12px] py-20 px-6 md:px-12 flex items-center justify-center border-t border-[rgba(244,241,236,0.12)]"
    >
      <div className="w-full max-w-[960px] grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20">
